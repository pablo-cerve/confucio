...
class CreatePDF:
    ...
    def run(self):
        self.run_for_folder('/001-100/')
        self.run_for_folder('/101-200/')
        self.run_for_folder('/201-300/')
        self.run_for_folder('/301-400/')
        self.run_for_folder('/401-500/')
        self.run_for_folder('/501-600/')
